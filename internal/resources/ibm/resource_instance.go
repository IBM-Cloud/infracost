...
var ResourceInstanceUsageSchema = []*schema.UsageItem{
	...
	{Key: "event-notifications_OUTBOUND_DIGITAL_MESSAGE_CUSTOM_DOMAIN_EMAIL", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_OUTBOUND_DIGITAL_MESSAGES_EMAILS", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_OUTBOUND_DIGITAL_MESSAGES_HTTP", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_OUTBOUND_DIGITAL_MESSAGES_PUSH", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_OUTBOUND_DIGITAL_MESSAGES_SMS_UNITS", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_PUSH_PREPROD_DESTINATION_INSTANCES", DefaultValue: 1, ValueType: schema.Int64},
	{Key: "event-notifications_PUSH_DESTINATION_INSTANCES", DefaultValue: 1, ValueType: schema.Int64},
