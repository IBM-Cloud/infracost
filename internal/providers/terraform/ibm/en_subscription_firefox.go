...
func getEnSubscriptionFirefoxRegistryItem() *schema.RegistryItem {
	return &schema.RegistryItem{
		Name:                "ibm_en_subscription_firefox",
		RFunc:               newEnSubscriptionFirefox,
		ReferenceAttributes: []string{"instance_guid"},
	}
}

func newEnSubscriptionFirefox(d *schema.ResourceData, u *schema.UsageData) *schema.Resource {
