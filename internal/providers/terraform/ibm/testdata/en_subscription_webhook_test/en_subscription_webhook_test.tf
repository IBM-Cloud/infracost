...
resource "ibm_en_subscription_webhook" "subscription_webhook_lite" {
...
resource "ibm_en_subscription_webhook" "subscription_webhook_standard" {
...
resource "ibm_en_subscription_webhook" "subscription_webhook_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "Webhook Subscription"
  description    = "Webhook Subscription for Event Notifications"
  destination_id = "somedestinationid"
