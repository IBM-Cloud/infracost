...
resource "ibm_en_subscription_android" "subscription_android_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "Android Subscription"
  description    = "Android Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_android" "subscription_android_standard" {
...
resource "ibm_en_subscription_android" "subscription_android_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "Android Subscription"
  description    = "Android Subscription for Event Notifications"
  destination_id = "somedestinationid"
