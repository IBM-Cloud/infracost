...
resource "ibm_en_subscription_email" "subscription_email_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "E-mail Subscription"
  description    = "E-mail Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_email" "subscription_email_standard" {
...
resource "ibm_en_subscription_email" "subscription_email_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "E-mail Subscription"
  description    = "E-mail Subscription for Event Notifications"
  destination_id = "somedestinationid"
