...
resource "ibm_en_subscription_safari" "subscription_safari_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "Safari Subscription"
  description    = "Safari Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_safari" "subscription_safari_standard" {
...
resource "ibm_en_subscription_safari" "subscription_safari_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "Safari Subscription"
  description    = "Safari Subscription for Event Notifications"
  destination_id = "somedestinationid"
