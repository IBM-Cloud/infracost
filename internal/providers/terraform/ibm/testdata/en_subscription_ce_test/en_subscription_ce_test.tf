...
resource "ibm_en_subscription_ce" "subscription_ce_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "Code Engine Subscription"
  description    = "Code Engine Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_ce" "subscription_ce_standard" {
...
resource "ibm_en_subscription_ce" "subscription_ce_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "Code Engine Subscription"
  description    = "Code Engine Subscription for Event Notifications"
  destination_id = "somedestinationid"
