...
resource "ibm_en_subscription_sn" "subscription_sn_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "ServiceNow Subscription"
  description    = "ServiceNow Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_sn" "subscription_sn_standard" {
...
resource "ibm_en_subscription_sn" "subscription_sn_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "ServiceNow Subscription"
  description    = "ServiceNow Subscription for Event Notifications"
  destination_id = "somedestinationid"
