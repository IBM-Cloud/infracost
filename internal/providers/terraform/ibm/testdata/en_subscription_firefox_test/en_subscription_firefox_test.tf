...
resource "ibm_en_subscription_firefox" "subscription_firefox_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "Firefox Subscription"
  description    = "Firefox Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_firefox" "subscription_firefox_standard" {
...
resource "ibm_en_subscription_firefox" "subscription_firefox_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "Firefox Subscription"
  description    = "Firefox Subscription for Event Notifications"
  destination_id = "somedestinationid"
