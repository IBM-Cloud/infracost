...
resource "ibm_en_subscription_pagerduty" "subscription_pagerduty_lite" {
  instance_guid  = ibm_resource_instance.event_notifications["lite"].guid
  name           = "PagerDuty Subscription"
  description    = "PagerDuty Subscription for Event Notifications"
  destination_id = "somedestinationid"
  topic_id       = "sometopicid"
}

resource "ibm_en_subscription_pagerduty" "subscription_pagerduty_standard" {
...
resource "ibm_en_subscription_pagerduty" "subscription_pagerduty_standard_no_usage" {
  instance_guid  = ibm_resource_instance.event_notifications["standard"].guid
  name           = "PagerDuty Subscription"
  description    = "PagerDuty Subscription for Event Notifications"
  destination_id = "somedestinationid"
