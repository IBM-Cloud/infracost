...
func getEnSubscriptionChromeRegistryItem() *schema.RegistryItem {
	return &schema.RegistryItem{
		Name:                "ibm_en_subscription_chrome",
		RFunc:               newEnSubscriptionChrome,
		ReferenceAttributes: []string{"instance_guid"},
	}
}

func newEnSubscriptionChrome(d *schema.ResourceData, u *schema.UsageData) *schema.Resource {
