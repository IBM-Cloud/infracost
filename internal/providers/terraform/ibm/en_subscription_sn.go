...
func getEnSubscriptionSnRegistryItem() *schema.RegistryItem {
	return &schema.RegistryItem{
		Name:                "ibm_en_subscription_sn",
		RFunc:               newEnSubscriptionSn,
		ReferenceAttributes: []string{"instance_guid"},
	}
}

func newEnSubscriptionSn(d *schema.ResourceData, u *schema.UsageData) *schema.Resource {
